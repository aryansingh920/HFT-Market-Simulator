...
Configuration file for simulating an Nvidia–like stock.
This config captures many hyper–parameters including multiple market regimes,
GARCH dynamics, macro–economic impacts, advanced volatility and jump parameters,
as well as optional regime–switch and sentiment/news–based enhancements.
"""
